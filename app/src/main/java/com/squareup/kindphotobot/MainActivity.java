...
public class MainActivity extends AppCompatActivity {
  ...
  @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    posClient = PosSdk.createClient(this, "sq0idp-IrvD7sk2lU9IvEIUn0O0zQ");
    ...
    public void startTransaction() {
        ChargeRequest request = new ChargeRequest.Builder(1_00, USD).autoReturn(3200, TimeUnit.MILLISECONDS).build();
        try {
